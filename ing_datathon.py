...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="ING Datathon churn modeling pipeline")
    parser.add_argument(
        "--data-dir",
        default=".",
...
def main() -> None:
    ...
    if missing:
        ...
        raise FileNotFoundError(f"Missing required files in {data_dir}: {missing_list}")

    train_path = data_dir / "referance_data.csv"
